# Object-Detection-for-Visually-Impaired-Person
...
---> After detecting the objects we need to convert the text in the image to speech which helps the visually impaired to know about their environment.
